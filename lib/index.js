...
module.exports = Gzip = (function() {
  ...
  function Gzip(config) {
    ...
    this.targets = [
      {
        path: this._joinToPublic(((ref3 = this.options.paths) != null ? ref3.stylesheet : void 0) || ''),
        ext: /\.css$/
      }, {
        path: this._joinToPublic(((ref4 = this.options.paths) != null ? ref4.javascript : void 0) || ''),
        ext: /\.js$/
      }
    ];
  }
